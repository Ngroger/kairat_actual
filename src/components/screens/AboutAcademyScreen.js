        ...
        <View>
            ...
            <ScrollView ref={scrollViewRef} style={{ backgroundColor: '#FFF', width: '100%', height: '100%', marginTop: 120 }}>
                ...
                <View style={{ flexDirection: 'row', alignItems: 'center', display: 'flex', padding: 24 }}>
                    ...
                    <Text style={{ fontFamily: 'MulishExtraBold', fontSize: 20, marginLeft: 10 }}>ДОМАШНИЙ СТАДИОН</Text>
                </View>
                <Text style={{ paddingHorizontal: 24, fontSize: 16, fontFamily: 'MulishMedium' }}>
                    С первого дня и по сей день Центральный стадион является домашней ареной алматинского «Кайрата». 1960 год стал историческим для казахстанского футбола. Наша республика получила место в классе А (так сначала называлась высшая лига), которое занял сильнейший на тот момент клуб Казахской ССР – «Кайрат» из Алма-Аты. Наш болельщик впервые получил возможность воочию наблюдать за игрой лучших клубов СССР.{'\n'}{'\n'}

                    Все игры проходили на центральном стадионе южной столицы.
                </Text>
                <View style={{ flexDirection: 'row', alignItems: 'center', display: 'flex', padding: 24 }}>
                    <Text style={{ fontFamily: 'MulishExtraBold', fontSize: 20 }}>ЦЕНТРАЛЬНЫЙ СТАДИОН Г. АЛМАТЫ</Text>
                </View>
                <Text style={{ paddingHorizontal: 24, fontSize: 16, fontFamily: 'MulishMedium'  }}>
                    • Центральный стадион г. Алматы построен в 1958 году, расположен по адресу: г. Алматы, пр. Абая, 48. {'\n'}{'\n'}

                    • Стадион представляет собой сооружение, овальное в плане, разделенное вставками проходами на 4 трибуны: северную, западную, южную и восточную.{'\n'}{'\n'}

                    • Общая вместимость трибун составляет 23 804 мест. Сиденья обеспечивают удобство и формируют фигуру зрителя. Минимальная высота спинки – 38 см{'\n'}{'\n'}

                    • Для прохода зрителей и занимающихся – 4 входа с улиц пр. Абая, Сатпаева, Космонавтов. Для проезда автотранспорта существует два въезда – со стороны ул. Сатпаева и пр. Абая.{'\n'}{'\n'}

                    • Центральный стадион оборудован осветительными установками (прожекторами) с целью возможности проведения мероприятий в вечернее время. Уровень освещенности составляет 1400 люкс.{'\n'}{'\n'}

                    • Поверхность игрового футбольного поля: естественное травяное покрытие, ровное и гладкое, в хорошем состоянии.{'\n'}{'\n'}

                    • Игры на поле можно проводить в течение всего игрового сезона.{'\n'}{'\n'}
                    
                    • Размеры поля – 105 м х 68 м{'\n'}{'\n'}
                </Text>
                <View style={{ flexDirection: 'row', alignItems: 'center', display: 'flex', padding: 24 }}>
                ...
                <View>
                    <View style={{ paddingHorizontal: 24, paddingVertical: 10, flexDirection: 'row', display: 'flex' }}>
                        ...
                        <View style={{ marginLeft: 10 }}>
                            <Text style={{ fontSize: 16, fontFamily: 'MulishBold' }}>Администрация Клуба</Text>
                            <Text style={{ fontFamily: 'MulishRegular', fontSize: 12, marginTop: 20 }}>
                                Казахстан, г. Алматы, 050054,{'\n'}
                                ул. Майлина, 230{'\n'}
                                +7 727 339 03 49{'\n'}
                                +7 727 338 46 11{'\n'}
                                info@fckairat.kz{'\n'}
                    ...
                    <View style={{ paddingHorizontal: 24, paddingVertical: 10, flexDirection: 'row', display: 'flex' }}>
                        ...
                        <View style={{ marginLeft: 10 }}>
                            <Text style={{ fontSize: 16, fontFamily: 'MulishBold', width: 150 }}>Тренировачная база ФК “КАЙРАТ”</Text>
                            <Text style={{ fontFamily: 'MulishRegular', fontSize: 12, marginTop: 12, width: 150 }}>
                                Казахстан, г. Алматы, ул. Хамраева 1{'\n'}
                                +7 727 338 46 11{'\n'}
                                info@fckairat.kz{'\n'}
                            </Text>
                        </View>
                    ...
                    <View style={{ paddingHorizontal: 24, paddingVertical: 10, flexDirection: 'row', display: 'flex' }}>
                        ...
                        <View style={{ marginLeft: 10 }}>
                            <Text style={{ fontSize: 16, fontFamily: 'MulishBold', width: 150 }}>Детская Академия им. С. П. Квочкина</Text>
                            <Text style={{ fontFamily: 'MulishRegular', fontSize: 12, marginTop: 12, width: 150 }}>
                                Казахстан, г. Алматы,{'\n'}
                                ул. Абиша Кекилбаева , 30{'\n'}
                                +7 727 338 46 11{'\n'}
                                info@fckairat.kz{'\n'}
                            </Text>
                        </View>
                    ...
                    <View style={{ paddingHorizontal: 24, paddingVertical: 10, flexDirection: 'row', display: 'flex' }}>
                        ...
                        <View style={{ marginLeft: 10 }}>
                            <Text style={{ fontSize: 16, fontFamily: 'MulishBold', width: 150 }}>Юношеская Академия им. Т. С. Сегизбаева</Text>
                            <Text style={{ fontFamily: 'MulishRegular', fontSize: 12, marginTop: 12, width: 150 }}>
                                Казахстан, г. Алматы,{'\n'} 
                                ул. Майлина, 230{'\n'}
                                +7 702 150 83 26{'\n'}
                                k.talasbayev@fckairat.kz{'\n'}
                            </Text>
                        </View>
                    </View>
                    <View style={{ paddingHorizontal: 24, paddingVertical: 10, flexDirection: 'row', display: 'flex' }}>
                        ...
                        <View style={{ marginLeft: 10 }}>
                            <Text style={{ fontSize: 16, fontFamily: 'MulishBold', width: 150 }}>Академия им. Е. А. Пехлеваниди</Text>
                            <Text style={{ fontFamily: 'MulishRegular', fontSize: 12, marginTop: 12, width: 150 }}>
                                Казахстан, г. Алматы,{'\n'}  
                                ул. Магнитная 13А{'\n'}  
                                +7 727 338 46 11{'\n'}  
                    ...
                    <View style={{ paddingHorizontal: 24, paddingVertical: 10, flexDirection: 'row', display: 'flex' }}>
                        ...
                        <View style={{ marginLeft: 10 }}>
                            <Text style={{ fontSize: 16, fontFamily: 'MulishBold', width: 150 }}>Официальный магазин ФК «Кайрат»</Text>
                            <Text style={{ fontFamily: 'MulishRegular', fontSize: 12, marginTop: 12, width: 150 }}>
                                Казахстан, г. Алматы,{'\n'} 
                                проспект Абая, 48/4{'\n'}
                                +7 727 222 11 72{'\n'}
                    ...
                    <View style={{ paddingHorizontal: 24, paddingVertical: 10, flexDirection: 'row', display: 'flex' }}>
                        ...
                        <View style={{ marginLeft: 10 }}>
                            <Text style={{ fontSize: 16, fontFamily: 'MulishBold', width: 150 }}>Спортивный бар ФК "Кайрат"</Text>
                            <Text style={{ fontFamily: 'MulishRegular', fontSize: 12, marginTop: 12, width: 150 }}>
                                Казахстан, г. Алматы,{'\n'}  
                                проспект Абая, 48{'\n'}
                                +7 747 657 34 53{'\n'}
                    ...
                    <View style={{ flexDirection: 'row', alignItems: 'center', display: 'flex', padding: 24 }}>
                        ...
                        <Text style={{ fontFamily: 'MulishExtraBold', fontSize: 20, marginLeft: 10 }}>РУКОВОДСТВО КЛУБА</Text>
                    </View>
                    <ScrollView horizontal>
                        <View style={{ marginLeft: 24 }}>
                            ...
                            <Text style={{ fontSize: 16, fontFamily: 'MulishBlack', padding: 12, width: '100%', borderBottomColor: '#FECC01', borderBottomWidth: 4 }}>Боранбаев Кайрат{'\n'}Советаевич</Text>
                            <Text style={{ fontFamily: 'MulishRegular', padding: 12, fontSize: 16, width: 200 }}>Председатель наблюдательного совета</Text>
                        </View>
                        <View style={{ marginLeft: 24 }}>
                            <View style={{ width: 251, height: 240, backgroundColor: '#D9D9D9', justifyContent: 'center', alignItems: 'center' }}>
                                <Image source={require('../../img/Group53.png')} style={{ position: 'absolute', zIndex: -10, width: '100%', height: '100%', resizeMode: 'cover' }}/>
                            ...
                            <Text style={{ fontSize: 16, fontFamily: 'MulishBlack', padding: 12, width: '100%', borderBottomColor: '#FECC01', borderBottomWidth: 4 }}>Есимов Аскар{'\n'}Асилбекович</Text>
                            <Text style={{ fontFamily: 'MulishRegular', padding: 12, fontSize: 16, width: 200 }}>Генеральный директор</Text>
                        </View>
                        <View style={{ marginLeft: 24 }}>
                            <View style={{ width: 251, height: 240, backgroundColor: '#D9D9D9', justifyContent: 'center', alignItems: 'center' }}>
                                <Image source={require('../../img/Group53.png')} style={{ position: 'absolute', zIndex: -10, width: '100%', height: '100%', resizeMode: 'cover' }}/>
                            ...
                            <Text style={{ fontSize: 16, fontFamily: 'MulishBlack', padding: 12, width: '100%', borderBottomColor: '#FECC01', borderBottomWidth: 4 }}>Лежнев Константин{'\n'}Александрович</Text>
                            <Text style={{ fontFamily: 'MulishRegular', padding: 12, fontSize: 16, width: 200 }}>Спортивный директор</Text>
                        </View>
                        <View style={{ marginLeft: 24, marginRight: 24 }}>
                            ...
                            <Text style={{ fontSize: 16, fontFamily: 'MulishBlack', padding: 12, width: '100%', borderBottomColor: '#FECC01', borderBottomWidth: 4 }}>Красиков Евгений{'\n'}Андреевич</Text>
                            <Text style={{ fontFamily: 'MulishRegular', padding: 12, fontSize: 16, width: 200 }}>Технический директор</Text>
                        </View>
                    </ScrollView>
                    <OurPartners/>
                </View>
                <View style={{ paddingHorizontal: 24, marginTop: 10 }}>
                    <View style={{ borderBottomColor: '#FECC01', borderBottomWidth: 3, width: '100%', paddingVertical: 12 }}>
                        <TouchableOpacity onPress={() => setIsShowOffer(!isShowOffer)} style={{ flexDirection: 'row', alignItems: 'center', display: 'flex', paddingHorizontal: 6, justifyContent: 'space-between' }}>
                            <Text style={{ fontFamily: 'MulishBlack', fontSize: 16 }}>• ПРЕДЛОЖЕНИЕ О СОТРУДНИЧЕСТВЕ</Text>
                        ...
                        { isShowOffer && (
                            <Text style={{ fontSize: 16, marginTop: 10, fontFamily: 'MulishRegular' }}>
                                «Кайрат» стремится к максимальной прозрачности освещения событий, происходящих в клубе, и уделяет работе со средствами массовой информации особое внимание.{'\n'}{'\n'}

                                На домашних матчах футбольного клуба «Кайрат» работают десятки журналистов, фотографов и телевизионных операторов. Для удобства журналистов на домашней арене клуба в дни матчей работает пресс-центр, оборудованный беспроводным доступом в интернет.{'\n'}{'\n'}

                                «Кайрат» регулярно проводит пресс-конференции и встречи со средствами массовой информации. Аккредитация на матчи «Кайрата» подразумевает свободное посещение пресс-конференций и домашних матчей клуба на Центральном стадионе города Алматы.{'\n'}{'\n'}

                                Анонсы всех клубных мероприятий, открытых для посещения журналистами, публикуются на официальном сайте клубе – www.fckairat.com.{'\n'}{'\n'}
                            </Text>
                        ) }
                    </View>
                </View>
                ...
                <View style={{ paddingHorizontal: 24 }}>
                    <View style={{ backgroundColor: '#FECC01', width: '100%', borderRadius: 12, padding: 12, flexDirection: 'row', display: 'flex'}}>
                        <Image style={{ width: 69, height: 125, resizeMode: 'center' }} source={require('../../img/123.svg')}/>
                        <View style={{ marginLeft: 12 }}>
                            <Text style={{ fontSize: 16, fontFamily: 'MulishBlack' }}>Преесс-служба ФК Кайрат</Text>
                            <Text style={{ fontSize: 16, fontFamily: 'MulishRegular', marginTop: 10 }}>
                                г. Алматы, улица Майлина, 230{'\n'} 
                                +7 727 393 13 93,  вн. 151{'\n'}
                                press@fckairat.kz{'\n'}
                            </Text>
                            <TouchableOpacity style={{ alignItems: 'center', justifyContent: 'center', backgroundColor: '#FFF', borderRadius: 12, width: 170, padding: 6 }}>
                                <Text style={{ fontSize: 16, fontFamily: 'MulishMedium' }}>Отправить запрос</Text>
                            </TouchableOpacity>
                        </View>
                    </View>
                </View>
