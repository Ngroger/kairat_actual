...
class AppNavigation extends Component {
    render() {
        ...
        const mainName = `${t('main-tab')}`
        const section = `${t('selection')}`;
        const tickets = `${t('tickets')}`;
        const profile = `${t('cabinet')}`;
        const shopScreen = `${t('shop')}`
        return (
            <NavigationContainer>
                <Stack.Navigator initialRouteName="Main">
                    <Stack.Screen name="MainTabs" options={{ headerShown: false }}>
                        ...
                        <Tab.Navigator
                            ...
                            screenOptions={({ route }) => ({
                                ...
                                if (rn === section) {
                                    ...
                                    <Svg xmlns="http://www.w3.org/2000/svg" width={25} height={25} viewBox="0 0 20 20" fill="none">
                                        <Path d="M12.8245 4.34199L13.9995 6.69199C14.1578 7.01699 14.5828 7.32532 14.9411 7.39198L17.0661 7.74198C18.4245 7.96698 18.7411 8.95032 17.7661 9.93365L16.1078 11.592C15.8328 11.867 15.6745 12.4087 15.7661 12.8003L16.2411 14.8503C16.6161 16.467 15.7495 17.1003 14.3245 16.2503L12.3328 15.067C11.9745 14.8503 11.3745 14.8503 11.0161 15.067L9.02446 16.2503C7.59946 17.092 6.7328 16.467 7.1078 14.8503L7.58281 12.8003C7.67448 12.417 7.51614 11.8753 7.24114 11.592L5.58281 9.93365C4.60781 8.95865 4.92448 7.97531 6.28281 7.74198L8.4078 7.39198C8.76613 7.33365 9.19114 7.01699 9.34947 6.69199L10.5245 4.34199C11.1495 3.06699 12.1828 3.06699 12.8245 4.34199Z" stroke={focused ? '#FECC01' : '#231F20'} strokeWidth={1.5} strokeLinecap="round" strokeLinejoin="round"/>
                                        <Path d="M6.66699 4.1665H1.66699" stroke={focused ? '#FECC01' : '#231F20'} strokeWidth={1.5} strokeLinecap="round" strokeLinejoin="round"/>
                                        <Path d="M4.16699 15.8335H1.66699" stroke={focused ? '#FECC01' : '#231F20'} strokeWidth={1.5} strokeLinecap="round" strokeLinejoin="round"/>
                                        <Path d="M2.50033 10H1.66699" stroke={focused ? '#FECC01' : '#231F20'} strokeWidth={1.5} strokeLinecap="round" strokeLinejoin="round"/>
                                    </Svg>
                                    );
                                }
                                if (rn === tickets) {
                                ...
                                if (rn === profile) {
                                    ...
                                    return (
                                        <Svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" viewBox="0 0 17 18" fill="none">
                                            <Path d="M8.54587 9.54999C8.49651 9.54294 8.43305 9.54294 8.37664 9.54999C7.13562 9.50768 6.14844 8.49229 6.14844 7.24422C6.14844 5.96794 7.17792 4.9314 8.46126 4.9314C9.73754 4.9314 10.7741 5.96794 10.7741 7.24422C10.767 8.49229 9.7869 9.50768 8.54587 9.54999Z" stroke={focused ? '#FECC01' : '#231F20'} stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                                            <Path d="M13.2141 14.2041C11.959 15.3535 10.2949 16.0515 8.46155 16.0515C6.62821 16.0515 4.96411 15.3535 3.70898 14.2041C3.7795 13.5413 4.20257 12.8926 4.95706 12.3849C6.88911 11.1015 10.0481 11.1015 11.966 12.3849C12.7205 12.8926 13.1436 13.5413 13.2141 14.2041Z" stroke={focused ? '#FECC01' : '#231F20'} stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                                            <Path d="M8.46144 16.0513C12.3558 16.0513 15.5127 12.8943 15.5127 9.00001C15.5127 5.1057 12.3558 1.94873 8.46144 1.94873C4.56712 1.94873 1.41016 5.1057 1.41016 9.00001C1.41016 12.8943 4.56712 16.0513 8.46144 16.0513Z" stroke={focused ? '#FECC01' : '#231F20'} stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                                        </Svg>
                                    );
                                }
                                if (rn === shopScreen) {
                                    ...
                                    <Svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 18 18" fill="none">  
                                        <Path d="M6.7627 10.5864C6.7627 11.9403 7.8768 13.0544 9.23064 13.0544C10.5845 13.0544 11.6986 11.9403 11.6986 10.5864" stroke={focused ? '#FECC01' : '#231F20'} stroke-width="1.5" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round"/>
                                        <Path d="M6.98225 1.94873L4.42969 4.50835" stroke={focused ? '#FECC01' : '#231F20'} stroke-width="1.5" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round"/>
                                        <Path d="M11.4814 1.94873L14.034 4.50835" stroke={focused ? '#FECC01' : '#231F20'} stroke-width="1.5" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round"/>
                                        <Path d="M2.17969 6.07383C2.17969 4.76934 2.87776 4.66357 3.74507 4.66357H14.7169C15.5842 4.66357 16.2823 4.76934 16.2823 6.07383C16.2823 7.58986 15.5842 7.48409 14.7169 7.48409H3.74507C2.87776 7.48409 2.17969 7.58986 2.17969 6.07383Z" stroke={focused ? '#FECC01' : '#231F20'} stroke-width="1.5"/>
                                        <Path d="M3.2373 7.5896L4.23154 13.6819C4.45718 15.0499 5.00013 16.0511 7.01679 16.0511H11.2687C13.4617 16.0511 13.786 15.0922 14.0399 13.7665L15.2245 7.5896" stroke={focused ? '#FECC01' : '#231F20'} stroke-width="1.5" stroke-linecap="round"/>                                
                                    </Svg>
                                    );
                                }
                                },
                                tabBarInactiveTintColor: '#231F20', // Цвет подсказок без фокуса
                                tabBarActiveTintColor: '#FECC01', // Цвет подсказок при фокусе
                                tabBarLabelStyle: {
                                fontSize: 12
                                },
                            })}
                            ...
                            <Tab.Screen name={section} component={AcademyScreen} />
