...
function Navbar({ title, activityApp }) {
    ...
    const [language, setLanguage] = useState(i18next.language === 'ru' ? 'RU' : 'KZ');
    ...
    const loadCurrentLanguage = async () => {
        ...
        if (selectedLanguage) {
            setLanguage(selectedLanguage === 'ru' ? 'RU' : 'KZ');
        ...
        <View style={ isOpenMenu || isOpenRegistration === true ? { position: 'absolute', zIndex: 100000, width: '100%', height: '100%' } : { position: 'absolute', zIndex: 100000, width: '100%' } }>
            <View>
                <View style={styles.buttonsContainer}>
                    <TouchableOpacity onPress={() => navigation.navigate('Отбор')} style={{ marginLeft: 70 }}>
                    ...
                    <TouchableOpacity onPress={() => navigation.navigate('Билеты')} style={activityApp === 'Ticket' ? { marginLeft: 20, opacity: 0.5 } : { marginLeft: 20 }}>
                    ...
                    <TouchableOpacity onPress={() => navigation.navigate('ProfileScreen')} style={activityApp === 'Profile' ? { marginLeft: 20, opacity: 0.5 } : { marginLeft: 20 }}>
                    ...
                    <TouchableOpacity onPress={() => navigation.navigate(t("shop"), { slug: "" })} style={{ marginLeft: 20 }}>
                    ...
                    { isShowLanguageSelector && (
                        <View style={{ backgroundColor: '#FFF', width: '11%', position: 'absolute', zIndex: 100, top: 60, right: 35 }}>
                            { language === 'RU' ? (
                ...
                <View style={styles.titleContainer}>
                    <TouchableOpacity style={{position: 'absolute', zIndex: 10, left: 0, top: -27,}} onPress={() => navigation.navigate('Главная')}>
                        <Image style={styles.logo} source={require('../../img/Logo-kairat_new.png')}/>
                    </TouchableOpacity>
